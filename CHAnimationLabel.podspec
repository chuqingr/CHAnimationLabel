...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of CHAnimationLabel.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/杨胜浩/CHAnimationLabel'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { '杨胜浩' => 'chuqingr@icloud.com' }
  s.source           = { :git => 'https://github.com/杨胜浩/CHAnimationLabel.git', :tag => s.version.to_s }
